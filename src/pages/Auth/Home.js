                            ...
                            <div className="col-12">
                                <div className="d-block d-md-flex align-items-center text-center">
                                    <div className="me-4 d-inline-block py-1">
                                        <a href="index.html#"><i className="far fa-envelope me-2 fa-flip-horizontal text-primary"></i>erptechin@gmail.com</a>
                                    </div>
                                    <div className="me-auto d-inline-block py-1">
                                        <a href="tel:1-800-555-1234"><i className="fas fa-map-marker-alt text-primary me-2"></i>Mancheswar Hitech Square, Behind Koel Care Bhubaneswar</a>
                                    </div>
                        ...
                        <div className="navbar-collapse collapse">
                            <ul className="nav navbar-nav">
                                ...
                                <li className="dropdown nav-item">
                                    <a href="https://themes.potenzaglobalsolutions.com/html/hi-soft/properties.html" className="nav-link" data-bs-toggle="dropdown">Pages</a>
                                ...
                                <li className="dropdown nav-item">
                                    <a href="https://themes.potenzaglobalsolutions.com/html/hi-soft/properties.html" className="nav-link" data-bs-toggle="dropdown">Company</a>
                                    <ul className="dropdown-menu">
                                ...
                                <li className="dropdown nav-item">
                                    <a href="https://themes.potenzaglobalsolutions.com/html/hi-soft/properties.html" className="nav-link" data-bs-toggle="dropdown">Case Studies</a>
                                    <ul className="dropdown-menu">
                        ...
                        <div className="d-none d-sm-flex ms-auto me-5 me-lg-0 pe-4 pe-lg-0">
                            <ul className="nav ms-1 ms-lg-2 align-self-center">
                                <li className="contact-number nav-item pe-4 ">
                                    <a className="fw-bold" href="index.html#"><i className="fab fa-whatsapp pe-2"></i>+91 8637272263</a>
                                </li>
